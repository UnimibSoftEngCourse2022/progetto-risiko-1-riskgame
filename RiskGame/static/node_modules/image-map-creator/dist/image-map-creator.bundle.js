! function(t, e) {
      ...
      return function(t) {
        ...
        o = [], void 0 === (r = "function" == typeof(i = function() {
          return function t(e, n, i) {
            ...
            if (/^data:([\w+-]+\/[\w+.-]+)?[,;]/.test(c)) {
              ...
              for (var g = 0, b = new Uint8Array(c.length), m = b.length; g < m; ++g) b[g] = c.charCodeAt(g);
              c = new p([b], {
                type: u
              })
            }
        ...
        function y(t, e) {
          ...
          if (e.singleton) {
            var s = l++;
            n = c || (c = b(e)), i = _.bind(null, n, s, !1), o = _.bind(null, n, s, !0)
          ...
          }) : (n = b(e), i = A.bind(null, n), o = function() {
            g(n)
          });
          return i(t),
            function(e) {
        ...
        var r, s = function() {
          ...
          u = function() {
            function t(t, e, n, i, o, g) {
              void 0 === e && (e = []), void 0 === n && (n = ""), void 0 === i && (i = ""), void 0 === o && (o = 0), void 0 === g && (g = ""), this.shape = t, this.coords = e, this.href = n, this.title = i, this.id = o, this.group=g
            }
            return t.fromObject = function(t) {
              switch (t.shape) {
                case "rect":
                  var e = t;
                  return new d(e.coords.map(s.fromObject), e.href, e.title, e.group, e.id);
                case "circle":
                  var n = t;
                  return new l(n.coords.map(s.fromObject), n.radius, n.href, n.title, n.group, n.id);
                case "poly":
                  var i = t;
                  return new h(i.coords.map(s.fromObject), i.href, i.title, i.id, i.group, i.closed);
                case "default":
                  var o = t;
              ...
              e = e ? 'coords="' + e + '"' : "";
              var n = this.href ? 'href="' + this.href + '"' : "nohref",
                i = this.title ? 'title="' + this.title + '"' : "";
          ...
          f = function() {
            ...
            return t.prototype.setFromObject = function(t) {
              ...
              })), '<map name="' + document.getElementById('nome-mappa').value + '" id="' + this.name + '">\n' + e.join("\n") + "\n</map>"
            }, t.prototype.toSvg = function(t) {
              void 0 === t && (t = 1);
              var e = [];
          ...
          C = function() {
            function t(t, e, n) {
              ...
              void 0 === e && (e = 600), void 0 === n && (n = 450), this.menu = {
                SetTitle: {
                  ...
                  label: "Assegna il nome del Territorio"
                },
                SetGroup: {
                  onSelect: function(t, e, n, o) {
                    i.setAreaGroup(o)
                  },
                  label: "Assegna il nome del Continente"
                },
              ...
              this.width = e, this.height = n, this.tool = "Poligono", this.drawingTools = ["Rettangolo", "Cerchio", "Poligono"], this.settings, this.tempArea = new c, this.selection = new g, this.hoveredArea = null, this.hoveredPoint = null, this.map = new f(e, n), this.undoManager = new y.a, this.img = {
                data: null,
                file: null
              }, this.view = {
                scale: 1,
            ...
            return t.prototype.sketch = function(t) {
              ...
              var t = this;
              this.p5.createCanvas(this.width, this.height).drop(this.handeFile.bind(this)).dragLeave(this.onLeave.bind(this)).dragOver(this.onOver.bind(this)), this.settings = w.a.create(this.p5.width + 5, 0, "Editor Mappa", this.p5.canvas.parentElement).setDraggable(!1)/*.addText("Nome Mappa", "", (function(e) {
                t.map.setName(e)
              }))*/.addDropDown("Tool", ["Poligono", "Rettangolo", "Cerchio", "Selezione", "Elimina", "Test"], (function(e) {
                t.setTool(e.value)
              }))/*.addBoolean("Default Area", this.map.hasDefaultArea, (function(e) {
                t.setDefaultArea(e)
              }))*/.addButton("Indietro", this.undoManager.undo).addButton("Avanti", this.undoManager.redo).addButton("Cancella", this.clearAreas.bind(this)).addButton("Genera Html", (function() {
                t.settings.setValue("Output", t.map.toHtml())
              }))/*.addButton("Generate Svg", (function() {
                t.settings.setValue("Output", t.map.toSvg())
              }))*/.addTextArea("Output").addButton("Salva", this.save.bind(this)), this.p5.canvas.addEventListener("contextmenu", (function(t) {
                t.preventDefault()
              ...
              return "Poligono" != this.tool || t.keyCode != this.p5.ESCAPE || (this.tempArea = new c, !1)
              ...
              if (this.mouseIsHoverSketch() && this.hoveredArea)
                ...
                case "Test":
                  e = this.hoveredArea.getHref(), void 0 === n && (n = 400), void 0 === i && (i = 300), window.open(e, "_blank", "width=" + n + ",height=" + i);
                  break;
                case "Elimina":
              ...
              if (this.p5.background(200), !this.img.data) {
                ...
                this.p5.text("Trascinare e rilasciare un'immagine o un file map.json", this.p5.width / 2, this.p5.height / 2)
              }
            }, t.prototype.setTitle = function(t) {
              "Test" == this.tool && t && t.getTitle() ? this.p5.canvas.setAttribute("title", t.getTitle()) : this.p5.canvas.removeAttribute("title")
            }, t.prototype.setAreaStyle = function(t) {
              var e = this.p5.color(255, 255, 255, 178);
              "Test" == this.tool && (e = this.p5.color(255, 0)), (("Elimina" == this.tool || "Selezione" == this.tool) && this.mouseIsHoverSketch() && t == this.hoveredArea || this.selection.containsArea(t)) && (e = this.p5.color(255, 200, 200, 178)), this.p5.fill(e), this.p5.strokeWeight(1 / this.view.scale), "Test" == this.tool ? this.p5.noStroke() : this.p5.stroke(0)
              ...
              b(t, document.getElementById('nome-mappa').value + ".map.json", "application/json")
            }, t.prototype.importMap = function(t) {
              var e = JSON.parse(t).map;
              this.map.setFromObject(e), this.settings.setValue("Nome Mappa:", e.name), this.settings.setValue("Default Area", e.hasDefaultArea), this.reset()
              ...
              var e = t.getHref(),
                n = prompt("Enter the pointing url of this area", e || "http://");
              ...
              var e = t.getTitle(),
                n = prompt("Inserisci il nome del Territorio", e || "");
            ...
            },t.prototype.setAreaGroup = function(t) {
              var e = t.getGroup(),
                n = prompt("Inserisci il nome del Continente", e || "");
              n && (t.setGroup(n), this.undoManager.add({
                undo: function() {
                  return t.setGroup(e)
                },
                redo: function() {
