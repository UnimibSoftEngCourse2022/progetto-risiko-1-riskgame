          ...
          C = function() {
            ...
            return t.prototype.sketch = function(t) {
              ...
              this.p5.createCanvas(this.width, this.height).drop(this.handeFile.bind(this)).dragLeave(this.onLeave.bind(this)).dragOver(this.onOver.bind(this)), this.settings = w.a.create(this.p5.width + 5, 0, "Editor Mappa", this.p5.canvas.parentElement).setDraggable(!1).addText("Nome Mappa", "", (function(e) {
                t.map.setName(e)
              })).addDropDown("Tool", ["Poligono", "Rettangolo", "Cerchio", "Seleziona", "Elimina", "Test"], (function(e) {
                t.setTool(e.value)
              ...
              "Test" == this.tool && (e = this.p5.color(255, 0)), (("Elimina" == this.tool || "Seleziona" == this.tool) && this.mouseIsHoverSketch() && t == this.hoveredArea || this.selection.containsArea(t)) && (e = this.p5.color(255, 200, 200, 178)), this.p5.fill(e), this.p5.strokeWeight(1 / this.view.scale), "Test" == this.tool ? this.p5.noStroke() : this.p5.stroke(0)
              ...
              b(t, this.map.getName() + ".map.json", "application/json")
